  ...
  return (
    <>
      ...
      >
        ...
        {!open && (
          <span className="absolute top-2 right-2 w-2.5 h-2.5 rounded-full bg-void animate-pulse" />
        )}
      </motion.button>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-2.5 shrink-0 bg-mint/10 border-b border-mint/20">
